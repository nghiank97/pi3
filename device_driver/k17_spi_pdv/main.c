...
u16 scr_width;
u16 scr_height;
static struct gpio_desc *A0_pin = NULL;
static struct gpio_desc *RST_pin = NULL;

#define CS0_pin 	8
#define CS_H()      (gpio_set_value(CS0_pin,1))
#define CS_L()      (gpio_set_value(CS0_pin,0))
#define A0_H()      (gpiod_set_value(A0_pin,1))
#define A0_L()      (gpiod_set_value(A0_pin,0))
#define RST_H()     (gpiod_set_value(RST_pin,1))
#define RST_L()     (gpiod_set_value(RST_pin,0))
