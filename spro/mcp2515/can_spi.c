...
static u32 convertReg2ExtendedCANid(u08 tempRXBn_EIDH, u08 tempRXBn_EIDL, u08 tempRXBn_SIDH, u08 tempRXBn_SIDL);
static u32 convertReg2StandardCANid(u08 tempRXBn_SIDH, u08 tempRXBn_SIDL) ;
static void convertCANid2Reg(u32 tempPassedInID, u08 canIdType, id_reg_t *passedIdReg);
...
u08 CANSPI_Receive(uCAN_MSG *tempCanMsg) 
{
  ...
  if (rxStatus.rxBuffer != 0)
  {
    ...
    {
      tempCanMsg->frame.idType = (u08) dEXTENDED_CAN_MSG_ID_2_0B;
      tempCanMsg->frame.id = convertReg2ExtendedCANid(rxReg.RXBnEID8, rxReg.RXBnEID0, rxReg.RXBnSIDH, rxReg.RXBnSIDL);
    } 
    else 
    {
      /* Standard 타입 */
      tempCanMsg->frame.idType = (u08) dSTANDARD_CAN_MSG_ID_2_0B;
...
static u32 convertReg2ExtendedCANid(u08 tempRXBn_EIDH, u08 tempRXBn_EIDL, u08 tempRXBn_SIDH, u08 tempRXBn_SIDL) 
{
  u32 returnValue = 0;
  u32 ConvertedID = 0;
  u08 CAN_standardLo_ID_lo2bits;
  u08 CAN_standardLo_ID_hi3bits;
